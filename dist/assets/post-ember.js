...
define('post-ember/routes/post', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember['default'].Route.extend({
    ...
    setupLongPolling: function setupLongPolling() {
      this.set('iceBlockMetricTimer', Em.run.later(this, this.refreshPostData, 1000));
    },
    refreshPostData: function refreshPostData() {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      statements: [
        ...
        ["content","model.post.author",["loc",[null,[3,11],[3,32]]]],
        ["content","model.post.title",["loc",[null,[4,10],[4,30]]]]
      ],
      locals: [],
      templates: []
    };
